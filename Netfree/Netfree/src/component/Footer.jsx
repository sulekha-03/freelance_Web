...
import fiverrLogo from "../assets/logo.jpg";
      ...
      <Box display={{ base: "none", sm: "block" }}>
        ...
        >
          ...
          <List paddingBottom={"40px"}>
            ...
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Selling on Netfree</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Buying on Netfree</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Netfree Guides</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Netfree Workspace</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Learn</Link>
            </ListItem>
          ...
          <List paddingBottom={"40px"}>
            ...
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Netfree Pro</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Netfree Certified</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Become an Agency</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
              <Link>Netfree Enterprise</Link>
            </ListItem>
            <ListItem fontSize={"18px"} color={"#74767e"} paddingBottom={"5px"}>
